...
// Environment variables with fallbacks to hardcoded values for demo continuity
const SUPABASE_URL = import.meta.env.NEXT_PUBLIC_SUPABASE_URL || 'https://zcqxasctfnihvnjvolmx.supabase.co';
const SUPABASE_ANON_KEY = import.meta.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpjcXhhc2N0Zm5paHZuanZvbG14Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQxMzI5MTAsImV4cCI6MjA3OTcwODkxMH0.0NGEgWtXw3RjzrSxbzmdyTuiusYtn0WLjNY610a6kUA';
